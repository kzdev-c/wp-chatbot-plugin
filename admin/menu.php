...
function chatbot_add_admin_menu()
{
    ...
    $wp_chatbot_opts_modules = get_option( 'chatbot_modules', [] );
    if ( in_array( 'web_scraper', $wp_chatbot_opts_modules, true ) && get_option( 'preferred_module', 'web_scrapper' ) !== 'file_upload' ) {
        add_submenu_page(
            'chatbot_settings',
